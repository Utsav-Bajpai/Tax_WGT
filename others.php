...
<head>
  ...
  <!--=====TITLE=======-->
  <title> Other Services || Services</title>
      ...
      <div class="row">
        <div class="col-md-8 m-auto text-center">
          <div class="hadding hadding-sec">
            <h1>Other Business & Tax Services</h1>
            <h6>Home > Services > Other Services</h6>
        ...
        <div class="col-md-6">
          <div class="about-haddings">
            <div class="hadding hadding-p space-sm-30">
              <span class="span">Other Services</span>
              <h1>All-in-One Support for Your Business</h1>
              <p>From bookkeeping and FSSAI licensing to PAN/TAN applications and legal registrations — we offer
                additional services that support your day-to-day business and compliance needs.</p>

              <div class="space20"></div>
              <p>
                Please feel free to browse our website to see the Other services we offer as well as the many helpful
            ...
            <div class="check-list-all">
              <div class="row">
                <div class="col-md-4">
                  <div class="chek-list">
                    <p><img src="assets/img/icons/check.svg" alt=""> Accounting & TDS Filing</p>
                  </div>
                  <div class="space20"></div>
                  <div class="chek-list">
                    <p><img src="assets/img/icons/check.svg" alt=""> PAN & TAN Application</p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="chek-list">
                    <p><img src="assets/img/icons/check.svg" alt=""> FSSAI Food License</p>
                  </div>
                  <div class="space20"></div>
                  <div class="chek-list">
                    <p><img src="assets/img/icons/check.svg" alt=""> Shop & Establishment Registration</p>
                  </div>
                  <div class="space20"></div>
                  <div class="chek-list">
                    <p><img src="assets/img/icons/check.svg" alt=""> Monthly Bookkeeping</p>
                  </div>
                </div>
              </div>
            </div>
