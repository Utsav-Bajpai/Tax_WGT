      ...
      <div class="row">
        <div class="col-md-8 m-auto text-center">
          <div class="hadding hadding-sec">
            ...
            <h6>Home > Services > GST Compliance</h6>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-6">
          <div class="about-haddings">
            <div class="hadding hadding-p space-sm-30">
              ...
              <div class="space20"></div>
              <p>
                Please feel free to browse our website to see the GST services we offer as well as the many helpful
            ...
            <div class="check-list-all">
              <div class="row">
                <div class="col-md-4">
                  <div class="chek-list">
                    <p><img src="assets/img/icons/check.svg" alt=""> GST Registration (Regular & Composition)</p>
                  </div>
                  <div class="space20"></div>
                  <div class="chek-list">
                    <p><img src="assets/img/icons/check.svg" alt=""> Monthly/Quarterly GSTR Filings</p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="chek-list">
                    <p><img src="assets/img/icons/check.svg" alt=""> Input Tax Credit Reconciliation</p>
                  </div>
                  <div class="space20"></div>
                  <div class="chek-list">
                    <p><img src="assets/img/icons/check.svg" alt=""> Annual Return (GSTR-9)</p>
                  </div>
                  <div class="space20"></div>
                  <div class="chek-list">
                    <p><img src="assets/img/icons/check.svg" alt=""> Notice & Penalty Handling</p>
                  </div>
                </div>
              </div>
            </div>
